VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Form_SelectedSheetHelmet 
   Caption         =   "Template Form"
   ClientHeight    =   7860
   ClientLeft      =   84
   ClientTop       =   360
   ClientWidth     =   5736
   OleObjectBlob   =   "Form_SelectedSheetHelmet.frx":0000
   StartUpPosition =   2  '画面の中央
End
Attribute VB_Name = "Form_SelectedSheetHelmet"
