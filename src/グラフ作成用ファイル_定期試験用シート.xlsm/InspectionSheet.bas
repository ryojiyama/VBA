...
'*******************************************************************************
' メインプロシージャ
' 機能：ヘルメットデータをフィルタリングしてグループ化し、検査票シートを作成
' 引数：なし
'*******************************************************************************
...
'*******************************************************************************
' 機能：ヘルメットのデータ文字列を解析してHelmetDataオブジェクトを作成
' 引数：value - 解析する文字列データ
' 戻値：HelmetDataオブジェクト
'*******************************************************************************
...
'*******************************************************************************
' 機能：指定されたシート名が既に存在するかを確認
' 引数：sheetName - 確認するシート名
' 戻値：Boolean (存在する場合はTrue)
'*******************************************************************************
...
'*******************************************************************************
' 機能：グループ化されたデータをデバッグ出力
' 引数：groupedData - 出力するデータ
'*******************************************************************************
...
'*******************************************************************************
' 機能：LOG_Helmetシートのデータを対応する検査票シートに転記
' 引数：なし
'*******************************************************************************
...
End Sub
'*******************************************************************************
' 機能：作成された検査票シート名をCopiedSheetNamesシートに保存
...
'*******************************************************************************
' 機能：Fつき帽体の試験結果データを対応する検査票シートに転記
' 引数：なし
'*******************************************************************************
...
End Sub
'*******************************************************************************
' 機能：CopiedSheetNamesシートからシート名のコレクションを取得
' 引数：なし
' 戻値：シート名のCollection
'*******************************************************************************
...
End Sub
'*******************************************************************************
' 機能：LOG_Helmetシートのチャートを製品別に対応するシートに分配
' 引数：なし
'*******************************************************************************
